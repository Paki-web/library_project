...
<div class="wrapper">
    ...
    <section class="data">
        ...
        <form action="adminAdding.php" method="post">
                <input type="text" name="admin_firstname" placeholder="Imię">
                <input type="text" name="admin_lastname" placeholder="Nazwisko">
                <input type="text" name="admin_login" placeholder="Login">
                <input type="text" name="admin_pass" placeholder="Haslo">
                <input type="text" name="admin_pesel" placeholder="Pesel">
